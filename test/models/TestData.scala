...
object TestData {
  ...
  def loadScheduleData(debug: Boolean = false)(implicit pm: ScalaPersistenceManager) {
    ...
    val r1chemA = new models.courses.Section(chemA, "333211", Set(fall2012), Set(r1), r201)
    val r1chemB = new models.courses.Section(chemB, "333212", Set(spring2013), Set(r1), r201)
    val r2chemA = new models.courses.Section(chemA, "626561", Set(fall2012), Set(r2), r201)
    val r2chemB = new models.courses.Section(chemB, "626562", Set(spring2013), Set(r2), r201)
    val w1bioA = new models.courses.Section(bioA, "537561", Set(fall2012), Set(w1), r201)
    val w1bioB = new models.courses.Section(bioB, "537562", Set(spring2013), Set(w1), r201)
    val w2bioA = new models.courses.Section(bioA, "564561", Set(fall2012), Set(w2), r201)
    val w2bioB = new models.courses.Section(bioB, "564562", Set(spring2013), Set(w2), r201)
    val r1alg1A = new models.courses.Section(alg1A, "223461", Set(fall2012), Set(r1), r202)
    val r1alg1B = new models.courses.Section(alg1B, "223462", Set(spring2013), Set(r1), r202)
    val r2alg2A = new models.courses.Section(alg2A, "423421", Set(fall2012), Set(r2), r202)
    val r2alg2B = new models.courses.Section(alg2B, "423422", Set(spring2013), Set(r2), r202)
    val w1plan = new models.courses.Section(planning, "777777", Set(fall2012, spring2013), Set(w1), r202)
    val w2geoA = new models.courses.Section(geoA, "685671", Set(fall2012), Set(w2), r202)
    val w2geoB = new models.courses.Section(geoB, "685672", Set(spring2013), Set(w2), r202)
    val r1eng1A = new models.courses.Section(eng1A, "676771", Set(fall2012), Set(r1), r203)
    val r1eng1B = new models.courses.Section(eng1B, "676772", Set(spring2013), Set(r1), r203)
    val r2plan = new models.courses.Section(planning, "666666", Set(fall2012, spring2013), Set(r2), r203)
    val w1eng2A = new models.courses.Section(eng2A, "455771", Set(fall2012), Set(w1), r203)
    val w1eng2B = new models.courses.Section(eng2B, "455772", Set(spring2013), Set(w1), r203)
    val w2eng3A = new models.courses.Section(eng3A, "999991", Set(fall2012), Set(w2), r203)
    val w2eng3B = new models.courses.Section(eng3B, "999992", Set(spring2013), Set(w2), r203)
    val r1plan = new models.courses.Section(planning, "555555", Set(fall2012, spring2013), Set(r1), r204)
    val r2usHistA = new models.courses.Section(usHistA, "645721", Set(fall2012), Set(r2), r204)
    val r2usHistB = new models.courses.Section(usHistB, "645722", Set(spring2013), Set(r2), r204)
    val w1worldHistA = new models.courses.Section(worldHistA, "888881", Set(fall2012), Set(w1), r204)
    val w1worldHistB = new models.courses.Section(worldHistB, "888882", Set(spring2013), Set(w1), r204)
    val w2studySkill = new models.courses.Section(studySkills, "444444", Set(fall2012, spring2013), Set(w2), r204)
    pm.makePersistentAll(List(
    ...
    //Exponents Mastery
    val sentence1 = new Question("You can only add monomials if they have the same____","variable with the same exponents",1)
    val sentence2 = new Question("When you are ading monomials, _____ coefficients","add",1)
    val sentence3 = new Question("When you are adding monomials the bases and exponents _____","stay the same",1)
    val sentence4 = new Question("Allen is _____","amazing",1)
    val simpExprss1 = new Question("-4a + a","-3a",1)
    val simpExprss2 = new Question("(a^2)^4", "a^8", 1)
    ...
    val SentenceQSet1 = new QuestionSet(List(sentence1, sentence2))
    val SentenceQSet2 = new QuestionSet(List(sentence3, sentence4))
    ...
    val ExponentSection1 = new models.mastery.Section("Sentences","Complete the sentences below:",List(SentenceQSet1, SentenceQSet2))
    val ExponentSection2 = new models.mastery.Section("Simplifing","Simplify the following:",List(simpExprssQSet1, simpExprssQSet2, simpExprssQSet3))
    ...
    val simpRad2 = new Question("rad(180)","6rad(5)",1)
    val simpRad3 = new Question("rad(10) * rad(30)","10rad(3)",1)
    val simpRad4 = new Question("rad(2/25)","rad(2)/5",1)
    val simpRad5 = new Question("5rad(7) * rad(7)","35",1)
    val simpRad6 = new Question("rad(3) + rad(3)","2rad(3)",1)
    ...
    val simpRadQSet2 = new QuestionSet(List(simpRad4, simpRad5, simpRad6))
    val sqrtSection1 = new models.mastery.Section("Prime Factorization", "Write the prime factorization of each of the folowing:", List(primeFactorQSet1, primeFactorQSet2))
    val sqrtSection2 = new models.mastery.Section("Simplifing Radicals","Simplify the following:",List(simpRadQSet1, simpRadQSet2))
