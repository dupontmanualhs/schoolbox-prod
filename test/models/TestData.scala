...
object TestData {
  ...
  def loadScheduleData(debug: Boolean = false)(implicit pm: ScalaPersistenceManager) {
    ...
    val exponents8a = new Question(M("a^{-3}="), List("1/a^3"))
    val exponents8b = new Question(M("a^{-5}="), List("1/a^5"))
    val exponents8c = new Question(M("a^{-4}="), List("1/a^4"))
    val exponents8d = new Question(M("a^{-6}="), List("1/a^6"))
    val exponents9a = new Question(M("\\frac{a^4}{a^7}="), List("1/a^3"))
    val exponents9b = new Question(M("\\frac{a^3}{a^5}="), List("1/a^2"))
    val exponents9c = new Question(M("\\frac{a^2}{a^7}="), List("1/a^5"))
    val exponents9d = new Question(M("\\frac{a^3}{a^7}="), List("1/a^4"))
    val exponents9e = new Question(M("\\frac{a^5}{a^7}="), List("1/a^2"))
    val exponents9f = new Question(M("\\frac{a^5}{a^9}="), List("1/a^4"))
    ...
    val exponents12a = new Question(M("7a\\cdot 2a"), List("14a^2"))
    val exponents12b = new Question(M("3a\\cdot 4a"), List("12a^2"))
    val exponents12c = new Question(M("5a\\cdot 4a"), List("20a^2"))
    val exponents12d = new Question(M("7a\\cdot 3a"), List("21a^2"))
    val exponents12e = new Question(M("6a\\cdot 3a"), List("18a^2"))
    val exponents12f = new Question(M("6a\\cdot 5a"), List("30a^2"))
    ...
    val exponents15a = new Question(M("-5m^4n\\cdot -4mn^3"), List("20m^5n^4", "20n^4m^5"))
    val exponents15b = new Question(M("-5m^2n\\cdot -2mn^3"), List("10m^3n^4", "10n^4m^3"))
    val exponents15c = new Question(M("-5m^4n\\cdot -3mn^3"), List("15m^5n^4", "15n^4m^5"))
    val exponents15d = new Question(M("-5m^4n\\cdot -2mn^3"), List("10m^5n^4", "10n^4m^5"))
    val exponents15e = new Question(M("-5m^4n\\cdot -3mn^4"), List("15m^5n^5", "15n^5m^5"))
    ...
    val exponents17a = new Question(M("\\frac{a^{-2}}{a^{-7}}"), List("a^5"))
    val exponents17b = new Question(M("\\frac{a^{-2}}{a^{-5}}"), List("a^3"))
    val exponents17c = new Question(M("\\frac{a^{-4}}{a^{-6}}"), List("a^2"))
    val exponents17d = new Question(M("\\frac{a^{-3}}{a^{-7}}"), List("a^4"))
    val exponents17e = new Question(M("\\frac{a^{-3}}{a^{-8}}"), List("a^5"))
    val exponents18a = new Question(M("\\frac{3m^{-3}}{21m^3n^{-2}}"), List("n^2/7m^6"))
    val exponents18b = new Question(M("\\frac{3m^{-5}}{15m^3n^{-4}}"), List("n^4/5m^8"))
    val exponents18c = new Question(M("\\frac{3m^{-3}}{18m^3n^{-5}}"), List("n^5/6m^6"))
    val exponents18d = new Question(M("\\frac{6m^{-3}}{18m^4n^{-5}}"), List("n^5/3m^7"))
    val exponents18e = new Question(M("\\frac{15m^{-3}}{18m^4n^{-2}}"), List("5n^2/6m^7"))
    ...
    val exponents20a = new Question(M("\\frac{-6m^2n^4}{2m^4n}="), List("-3n^3/m^2"))
    val exponents20b = new Question(M("\\frac{-6m^2n^4}{3m^5n^{-1}}="), List("-2n^5/m^3"))
    val exponents20c = new Question(M("\\frac{-10m^4n^4}{2m^5n^{-2}}="), List("-5n^6/m"))
    val exponents20d = new Question(M("\\frac{-10m^4n^4}{20m^4n^{-2}}="), List("-n^6/2", "-1/2n^6", "-0.5n^6", "-.5n^6"))
    val exponents20e = new Question(M("\\frac{-14m^4n^4}{20m^4n^{-5}}="), List("-7n^9/10", "-7/10n^9", "(-7/10)n^9"))
    ...
    val exponents22a = new Question(M("\\frac{6a+9b}{21a}="), List("(2a+3b)/7a", "2/7+3b/7a"))
    val exponents22b = new Question(M("\\frac{6a+10b}{4a}="), List("(3a+5b)/2a", "3/2+5b/2a"))
    val exponents22c = new Question(M("\\frac{6a^2+10ab}{4a}="), List("(3a+5b)/2", "3a/2+5b/2"))
    val exponents22d = new Question(M("\\frac{6a+12ab}{4a}="), List("(3+6b)/2", "3/2+3b"))
    val exponents22e = new Question(M("\\frac{6a+12ab}{10a}="), List("(3+6b)/5", "3/5+6b/5"))
    val exponents22f = new Question(M("\\frac{8a+12ab}{10a}="), List("(4+6b)/5", "4/5+6b/5", "4/5+(6/5)b"))
    val exponents23a = new Question(M("\\frac{10a^3+15a^2}{5a^3}="), List("(2a+3)/a", "2+3/a"))
    val exponents23b = new Question(M("\\frac{10a^3+15a^2}{5a^4}="), List("(2a+3)/a^2", "2/a+3/a^2"))
    val exponents23c = new Question(M("\\frac{20a^3+15a^2}{5a^4}="), List("(4a+3)/a^2", "4/a+3/a^2"))
    val exponents23d = new Question(M("\\frac{10a^3+15a^2}{10a^3}="), List("(2a+3)/2a", "1+3/2a"))
    val exponents23e = new Question(M("\\frac{10a^3+15a^2}{10a^2}="), List("(2a+3)/2", "a+3/2", "3/2+a"))
    val exponents23f = new Question(M("\\frac{10a^3+15a^2}{25a}="), List("(2a^2+3a)/5", "2a^2/5+3a/5", "3a/5+2a^2/5"))
    ...
    val solvequations1a = new Question(M("10-\\frac{3}{4}n=14"), List("-16/3", "-5+1/3"))
    val solvequations1b = new Question(M("8-\\frac{4}{5}n=12"), List("-5"))
    val solvequations1c = new Question(M("2-\\frac{4}{5}n=12"), List("-25/2", "-12+1/2"))
    val solvequations1d = new Question(M("8-\\frac{3}{4}n=14"), List("-8"))
    val solvequations1e = new Question(M("8-\\frac{2}{3}n=14"), List("-9"))
    val solvequations2a = new Question(M("0=5(8n+4)"), List("-1/2"))
    val solvequations2b = new Question(M("0=2(5n-9)"), List("9/5", "1+4/5"))
    val solvequations2c = new Question(M("3(2n-5)+7=6n-8+n"), List("0"))
    val solvequations2d = new Question(M("0=3(4n-1)"), List("1/4"))
    val solvequations2e = new Question(M("0=5(9n-1)"), List("1/9"))
    val solvequations2f = new Question(M("0=5(9n-4)"), List("4/9"))
    val solvequations3a = new Question(M("n^2-12=4n"), List("6, -2", "-2, 6"))
    val solvequations3b = new Question(M("n^2+10n=24"), List("-12,2", "2,-12"))
    val solvequations3c = new Question(M("n^2+20=9n"), List("4,5", "5,4"))
    val solvequations3d = new Question(M("n^2=24-5n"), List("5/2,-4", "-4,5/2"))
    val solvequations3e = new Question(M("n^2-12=n"), List("4,-3", "-3,4"))
    val solvequations3f = new Question(M("n^2-18=3n"), List("-3,6", "6,-3"))
    val solvequations4a = new Question(M("5-(3n+6)+n=3-2n"), List("ns", "NS", "Ns", "no solution"))
    val solvequations4b = new Question(M("3(2n-1)+7=5n+4+n"), List("all real numbers", "ARN", "arn"))
    val solvequations4c = new Question(M("0=2(4n-9)"), List("9/4", "2+1/4"))
    val solvequations4d = new Question(M("(2n-5)(n+4)=0"), List("5/2,-4", "-4,5/2"))
    val solvequations4e = new Question(M("3(2n-5)+10=6n-5+n"), List("0"))
    val solvequations4f = new Question(M("9-(3n+6)+n=3-2n"), List("all real numbers", "ARN", "arn"))
    val solvequations5a = new Question(M("\\frac{2}{5}n+2=\\frac{2}{3}n-3"), List("75/4", "18+3/4"))
    val solvequations5b = new Question(M("\\frac{1}{5}n+2=\\frac{3}{4}n-3"), List("100/11", "9+1/11"))
    val solvequations5c = new Question(M("\\frac{2}{5}n+4=\\frac{3}{4}n-4"), List("20"))
    val solvequations5d = new Question(M("\\frac{4}{5}n+4=\\frac{3}{4}n-3"), List("-140"))
    val solvequations5e = new Question(M("\\frac{3}{5}n+4=\\frac{2}{3}n-3"), List("105"))
    val solvequations5f = new Question(M("\\frac{2}{5}n+4=\\frac{2}{3}n-3"), List("105/4", "26+1/4"))
    val solvequations6a = new Question(M("(3n+5)(2n-6)=0"), List("-5/3,3", "3,-5/3"))
    val solvequations6b = new Question(M("(2n-5)(n+4)=0"), List("5/2,-4", "-4,5/2"))
    val solvequations6c = new Question(M("(2n-7)(3n+1)=0"), List("7/2,-1/3", "-1/3,7/2"))
    val solvequations6d = new Question(M("1-3n=5n+1-8n"), List("all real numbers", "ARN", "arn"))
    val solvequations6e = new Question(M("(3n+4)(2n-9)=0"), List("-4/3,9/2", "9/2,-4/3"))
    val solvequations6f = new Question(M("(3n+2)(2n-9)=0"), List("-2/3,9/2", "9/2,-2/3"))
    val solvequations7a = new Question(M("3(2n-2)+10=6n+4+n"), List("0"))
    val solvequations7b = new Question(M("9-(3n+10)=7+n"), List("-2"))
    val solvequations7c = new Question(M("9-(3n+6)=7+5n"), List("-1/2"))
    val solvequations7d = new Question(M("9-(3n+6)+n=7-2n"), List("no solution", "NS", "Ns", "ns"))
    val solvequations7e = new Question(M("3(2n-5)+10=6n-5+n"), List("no solution", "NS", "Ns", "ns"))
    val solvequations8a = new Question(M("4(n+2)-10=5n-(6-2n)-2"), List("2"))
    val solvequations8b = new Question(M("10-3(n+3)=1"), List("0"))
    val solvequations8c = new Question(M("4(n+2)-10=3n-(3-n)+1"), List("all real numbers", "ARN", "arn"))
    val solvequations8d = new Question(M("4(n+2)-10=3n-(3+n)+1"), List("0"))
    val solvequations8e = new Question(M("4(n+2)-10=5n-(6-2n)+1"), List("1"))
    val solvequations8f = new Question(M("4(n+2)-10=5n-(6-2n)-2"), List("2"))
    val solvequations9a = new Question(M("b=\\frac{2}{3}a+14"), List("3/2b-21", "3b/2-21"))
    val solvequations9b = new Question(M("b=\\frac{2}{3}a+4"), List("3/2b-6", "3b/2-6"))
    val solvequations9c = new Question(M("b=\\frac{4}{3}a+4"), List("3/4b-3", "3b/4-3"))
    val solvequations9d = new Question(M("b=\\frac{5}{8}a+10"), List("8/5b-16", "8b/5-16"))
    val solvequations9e = new Question(M("b=\\frac{4}{3}a+10"), List("3/4b-15/2", "3b/4-15/2", "3/4b-15/2", "3b/4-15/2"))
    val solvequations9f = new Question(M("b=\\frac{2}{3}a+10"), List("3/2b-15", "2b/2-15"))
    val solvequations10a = new Question(M("\\frac{4(3a+2b)}{5c}=60"), List("25c-2/3b", "25c-2b/3"))
    val solvequations10b = new Question(M("\\frac{4(2a+6b)}{3c}=40"), List("15c-3b", "-3b+15c"))
    val solvequations10c = new Question(M("\\frac{4(5a+6b)}{3c}=40"), List("6c-6/5b", "6c-6b/5", "-6b/5+6c", "-6/5b+6c"))
    val solvequations10d = new Question(M("\\frac{2(5a-b)}{5c}=40"), List("b/5+20c", "1/5b+20c", "20c+1/5b", "20c+b/5"))
    val solvequations10e = new Question(M("\\frac{2(5a+b)}{5c}=40"), List("20c-b/5", "-b/5+20c", "-1/5b+20c", "20c-1/5b"))
    val solvequations10f = new Question(M("\\frac{4(5a+b)}{5c}=40"), List("10c-b/5", "-b/5+10c", "10c-1/5b", "-1/5b+10c"))
