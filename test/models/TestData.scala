...
object TestData {
  ...
  def loadScheduleData(debug: Boolean = false)(implicit pm: ScalaPersistenceManager) {
    ...
    val primeFactor1 = new Question("50","2*5*5",1,"Expression")
    val primeFactor2 = new Question("180", "2*2*3*3*5", 1, "Expression")
    val simpRad1 = new Question("rad(50)", "5sqrt(2)", 1, "Expression")
    val simpRad2 = new Question("rad(180)","6sqrt(5)",1, "Expression")
    val simpRad3 = new Question("rad(10) * rad(30)","10sqrt(3)",1, "Expression")
    val simpRad4 = new Question("rad(2/25)","sqrt(2)/5",1, "Expression")
    val simpRad5 = new Question("5rad(7) * rad(7)","35",1, "Expression")
    val simpRad6 = new Question("rad(3) + rad(3)","2sqrt(3)",1, "Expression")
    val sentence1 = new Question("You can only add monomials if they have the same____","variable with the same exponents",1, "Sentence")
    val sentence2 = new Question("When you are ading monomials, _____ coefficients","add",1, "Sentence")
    val sentence3 = new Question("When you are adding monomials the bases and exponents _____","stay the same",1, "Sentence")
    val sentence4 = new Question("Allen is _____","amazing",1, "Sentence")
    val simpExprss1 = new Question("-4a + a","-3a",1, "Expression")
    val simpExprss2 = new Question("(a^2)^4", "a^(8)", 1, "Expression")
    val simpExprss3 = new Question("a * a","a^2",1, "Expression")
    val simpExprss4 = new Question("7a * 3a", "21a^2", 1, "Expression")
    val simpExprss5 = new Question("(a + b)^2", "a^2+2ab+b^2", 1, "Expression")
