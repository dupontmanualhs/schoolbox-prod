...
object TestData {
  ...
  def loadScheduleData(debug: Boolean = false)(implicit pm: ScalaPersistenceManager) {
    ...
    val simpRad1 = new Question("rad(50)", "5rad(2)", 1, "Expression")
    val simpRad2 = new Question("rad(180)","6rad(5)",1, "Expression")
    val simpRad3 = new Question("rad(10) * rad(30)","10rad(3)",1, "Expression")
    val simpRad4 = new Question("rad(2/25)","rad(2)/5",1, "Expression")
    val simpRad5 = new Question("5rad(7) * rad(7)","35",1, "Expression")
    val simpRad6 = new Question("rad(3) + rad(3)","2rad(3)",1, "Expression")
    ...
    val simpExprss3 = new Question("a * a","2a",1, "Expression")
    val simpExprss4 = new Question("7a * 3a", "21a", 1, "Expression")
