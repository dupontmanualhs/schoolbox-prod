...
object TestData {
  ...
  def loadScheduleData(debug: Boolean = false)(implicit pm: ScalaPersistenceManager) {
    ...
    val simpRad1 = new Question("rad(50)", "5r(2)", 1, "Expression")
    val simpRad2 = new Question("rad(180)","6r(5)",1, "Expression")
    val simpRad3 = new Question("rad(10) * rad(30)","10r(3)",1, "Expression")
    val simpRad4 = new Question("rad(2/25)","r(2)/5",1, "Expression")
    val simpRad5 = new Question("5rad(7) * rad(7)","35",1, "Expression")
    val simpRad6 = new Question("rad(3) + rad(3)","2r(3)",1, "Expression")
