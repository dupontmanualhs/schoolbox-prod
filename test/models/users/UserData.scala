...
object UserData {  
  def load(debug: Boolean = false)(implicit pm: ScalaPersistenceManager) {
    ...
    val mac = new User("mac", "Mac", Some("Brick"), "House", None, Gender.MALE, "mac@mac.com", "hou123")
    ...
    val toddStud = new Student(todd, "3757202948", "425636", 0, "MST")
    ...
    val macStud = new Student(mac, "4907532423", "819823", 11, "MST")
    val ericStud = new Student(eric, "0572059453", "745105", 12, "MST")
